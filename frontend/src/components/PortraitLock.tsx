 ...
 * Por defecto está oculto (display: none); desktop/laptops (>900px) nunca
 * cumplen ambas condiciones y jamás lo ven.
 */
export default function PortraitLock() {
  return (
    <div className="portrait-lock fixed inset-0 z-[999] hidden items-center justify-center bg-slate-950/95 p-8 backdrop-blur-md">
